...
def generate_tone():
    ...
    frequency_end = 114  # Frequency to end the sweep at
    num_frequencies = 64  # Number of frequencies in the sweep
    amplitude = 0.50  # Amplitude of the waveform
    step_duration = 0.13  # Time (seconds) to play at each step
